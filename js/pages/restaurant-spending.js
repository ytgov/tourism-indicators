...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        // Load data directly
        const data = await loadCSVData('data/vw_kpi_economic_restaurant_spending.csv?'+Math.random());
        ...
        const monthlyConfig = {
            ...
            dataFile: 'data/vw_kpi_economic_restaurant_spending.csv?'+Math.random(),
